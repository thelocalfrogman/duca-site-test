        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          >
            <div className="max-w-lg">
              <h2 className="text-left text-balance text-2xl md:text-3xl lg:text-4xl font-semibold tracking-tight text-white">
                Join our Discord Community
              </h2>
              <p className="mt-4 text-left text-base/6 text-purple-200">
                Connect with 750+ cybersecurity enthusiasts. Get instant updates on events,
                ask questions, share resources, and network with fellow students and industry professionals.
              </p>
              <div className="mt-6">
                <Button
            ...
            <div className="absolute -right-4 -bottom-10 w-48 h-48 opacity-20">
          ...
          <WobbleCard containerClassName="col-span-1 bg-cyan-800 min-h-[300px]">
            <h2 className="text-left text-balance text-2xl md:text-xl lg:text-2xl font-semibold tracking-tight text-white">
              Become a Member
            </h2>
