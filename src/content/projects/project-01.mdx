...
<BreakoutImage src={`${baseUrl}projects/project-image-1.png`} />
...
<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
  <Image
    src={`${baseUrl}projects/project-image-1.png`}
  ...
  />
  <Image
    src={`${baseUrl}projects/project-image-2.png`}
  ...
  />
  <Image
    src={`${baseUrl}projects/project-image-3.png`}
  ...
  />
  <Image
    src={`${baseUrl}projects/project-image-4.png`}
...
<BreakoutImage src={`${baseUrl}projects/project-image-2.png`} />
